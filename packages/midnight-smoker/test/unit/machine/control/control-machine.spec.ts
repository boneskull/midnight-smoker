import {ERROR, OK, PACKAGE_JSON} from '#constants';
import {ErrorCodes} from '#error/codes';
import {SmokerEvent} from '#event/event-constants';
import {ControlMachine, type CtrlMachineInput} from '#machine/control';
import {LoaderMachine} from '#machine/loader';
        ...
        describe('.init', function () {
          describe('.initComponents', function () {
            ...
            describe('.loadingPlugins', function () {
              ...
              describe('when the LoaderMachine outputs the ERROR type', function () {
                it('should abort', async function () {
                  const err = new Error('yuk');
                  const {runUntilDone} = createActorRunner(
                    ControlMachine.provide({
                      actors: {
                        LoaderMachine: LoaderMachine.provide({
                          actors: {
