...
import type * as PkgUtil from '../../src/pkg-util';
...
describe('midnight-smoker', function () {
  ...
  beforeEach(function () {
    ...
    Util = rewiremock.proxy(() => require('../../src/pkg-util'), {
      'node:fs/promises': fs.promises,
      fs,
      'node:fs': fs,
      'node:child_process': ChildProcess,
    });
    Util.readPackageJson.resetCache();
    ({pickPackageVersion, getSystemPkgManagerVersion} = Util);
  });
