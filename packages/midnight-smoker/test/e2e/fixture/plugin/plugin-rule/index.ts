...
export const plugin = ({defineRule, z}: PluginAPI) => {
  defineRule({
    /**
    ...
    /**
     * This function performs the actual check. The `context` object
     * provides some extra information about the package being checked, the
     * rule's current severity, and the `addIssue` method.
     *
     * The `opts` object is the user's configuration for this rule, with
     * your defaults applied; it will be the same output type as the
     * `schema` property below.
     */
    check(context, opts) {
