...
exports[
  'midnight-smoker CLI flag --json when the test fails should provide helpful result 1'
] = `
{
  "results": [
    {
...
exports[
  'midnight-smoker CLI flag when the test passes should produce expected output 1'
] = `
...
exports[
  'midnight-smoker CLI flag when the test fails should produce expected output 1'
] = `
💨 midnight-smoker v3.0.4
- Packing current project...
✔ Packed 1 package
...
(runScript) Script "smoke" in package "fail" failed: Command failed with exit code 1: <path/to/>/bin/node <path/to/>/bin/npm run-script smoke
...
exports[
  'midnight-smoker CLI flag --json when the test passes should produce expected output 1'
] = `
{
  "results": [
    {
