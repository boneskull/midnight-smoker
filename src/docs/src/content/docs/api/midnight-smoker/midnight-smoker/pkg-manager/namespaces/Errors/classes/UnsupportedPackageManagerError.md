...
next: false
prev: false
title: "UnsupportedPackageManagerError"
---
...
### new UnsupportedPackageManagerError(message, name, version)

> **new UnsupportedPackageManagerError**(`message`, `name`, `version`): [`UnsupportedPackageManagerError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/unsupportedpackagemanagererror/)
...
[`UnsupportedPackageManagerError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/unsupportedpackagemanagererror/)
...
[packages/midnight-smoker/src/component/pkg-manager/errors/unsupported-pkg-manager-error.ts:11](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/unsupported-pkg-manager-error.ts#L11)
...
> **`readonly`** **id**: `"UnsupportedPackageManagerError"` = `'UnsupportedPackageManagerError'`
...
[packages/midnight-smoker/src/component/pkg-manager/errors/unsupported-pkg-manager-error.ts:10](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/unsupported-pkg-manager-error.ts#L10)
