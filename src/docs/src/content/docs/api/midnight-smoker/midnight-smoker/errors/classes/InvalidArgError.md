...
- [`BaseSmokerError`](/api/midnight-smoker/midnight-smoker/errors/classes/basesmokererror/)\<`Object`, `ValidationError` \| `void`\>

## Constructors

### new InvalidArgError(message, __namedParameters)

> **new InvalidArgError**(`message`, `__namedParameters`): [`InvalidArgError`](/api/midnight-smoker/midnight-smoker/errors/classes/invalidargerror/)
...
• **\_\_namedParameters\.argName?**: `string`

• **\_\_namedParameters\.position?**: `number`
...
[packages/midnight-smoker/src/error/common-error.ts:32](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/error/common-error.ts#L32)

## Properties

### cause?

> **`readonly`** **cause**?: `void` \| `ValidationError`
...
> **`readonly`** **id**: `"InvalidArgError"` = `'InvalidArgError'`
...
[packages/midnight-smoker/src/error/common-error.ts:30](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/error/common-error.ts#L30)
...
> ##### cause
>
> > **cause**: `undefined` \| `void` \| `ValidationError`
>
> ##### code
>
