...
next: false
prev: false
title: "ScriptFailedError"
---

## Todo

Add underlying error to `cause`
...
### new ScriptFailedError(message, context, cause)

> **new ScriptFailedError**(`message`, `context`?, `cause`?): [`ScriptFailedError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/scriptfailederror/)
...
• **context\.pkgManager?**: `string`

• **context\.pkgName?**: `string`
...
[`ScriptFailedError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/scriptfailederror/)
...
> **`readonly`** **id**: `"ScriptFailedError"` = `'ScriptFailedError'`
...
[packages/midnight-smoker/src/component/pkg-manager/errors/script-failed-error.ts:17](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/script-failed-error.ts#L17)
