...
### new PackError(message, pkgManager, dest, __namedParameters)

> **new PackError**(`message`, `pkgManager`, `dest`, `__namedParameters`): [`PackError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/packerror/)
...
[`PackError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/packerror/)
...
[packages/midnight-smoker/src/component/pkg-manager/errors/pack-error.ts:18](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/pack-error.ts#L18)
...
> **`readonly`** **id**: `"PackError"` = `'PackError'`
...
[packages/midnight-smoker/src/component/pkg-manager/errors/pack-error.ts:16](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/pack-error.ts#L16)
