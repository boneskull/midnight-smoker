...
### new MissingPackageJsonError(message, cwd)

> **new MissingPackageJsonError**(`message`, `cwd`): [`MissingPackageJsonError`](/api/midnight-smoker/midnight-smoker/util/classes/missingpackagejsonerror/)
...
packages/midnight-smoker/src/util/util-error.ts:10
...
> **`readonly`** **id**: `"MissingPackageJsonError"` = `'MissingPackageJsonError'`
...
packages/midnight-smoker/src/util/util-error.ts:9
