...
next: false
prev: false
title: "UnknownVersionRangeError"
---
...
### new UnknownVersionRangeError(message, pm, versionRange)

> **new UnknownVersionRangeError**(`message`, `pm`, `versionRange`): [`UnknownVersionRangeError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/unknownversionrangeerror/)
...
[`UnknownVersionRangeError`](/api/midnight-smoker/midnight-smoker/pkg-manager/namespaces/errors/classes/unknownversionrangeerror/)
...
[packages/midnight-smoker/src/component/pkg-manager/errors/unknown-version-range-error.ts:11](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/unknown-version-range-error.ts#L11)
...
> **`readonly`** **id**: `"UnknownVersionRangeError"` = `'UnknownVersionRangeError'`
...
[packages/midnight-smoker/src/component/pkg-manager/errors/unknown-version-range-error.ts:10](https://github.com/boneskull/midnight-smoker/blob/417858b/packages/midnight-smoker/src/component/pkg-manager/errors/unknown-version-range-error.ts#L10)
